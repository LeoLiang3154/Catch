...
public class SunFragment extends Fragment {
     ...
     * The Sun events.
     */
    List<Events> sunEvents = Events.find(Events.class, "weekday = ?", "Sunday");
    /**
     * The Initial count.
     */
    ...
    /**
     * The My sun event adapter.
     */
    EventAdapter mySunEventAdapter;

    /**
     * New instance sun fragment.
     *
     * @return the sun fragment
     */
    ...
    /**
     *onViewCreated for the adapter in SunFragment
     *
     *
     * @param view
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mySunEventAdapter = new EventAdapter(sunEvents, getContext());
        mRecyclerView.setAdapter(mySunEventAdapter);
    }
    ...
    public void onResume() {
        ...
        if (newCount > initialCount) {
            ...
            sunEvents.add(myMonEvent);
            mySunEventAdapter.notifyItemChanged((int) newCount);
        }
    }
}